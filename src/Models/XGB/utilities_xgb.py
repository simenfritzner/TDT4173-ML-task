...
def predict_y_with_XGB(y_to_fit, y_to_predict, X_observed, X_estimated, selected_features, wanted_months, hyperparameters):
    ...
    rf_augment_y = XGB_model(hyperparameters, X_train, X_y_pred, y_train)
    rf_augment_y.fit()
    rf_augment_y.pred()
